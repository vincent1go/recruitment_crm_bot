...
def найти_и_заменить_текст(страница, старый_текст, новый_текст, только_первые_n=0):
    ...
    for область in области:
        ...
        logger.info(f"Вставлен текст '{новый_текст}' на странице {страница.number + 1}, позиция: ({область.x0}, {область.y0})")
    return True
...
def generate_pdf(путь_к_шаблону: str, текст: str, пользовательская_дата: datetime = None, выходная_папка: str = ".") -> str:
    ...
    for страница in документ:
        ...
        # Замена Client:
        найти_и_заменить_текст(страница, "Client:", f"Client: {текст}")
        найти_и_заменить_текст(страница, "Client: ", f"Client: {текст}")  # Проверка с пробелом

        # Замена Date:
        найти_и_заменить_текст(страница, "Date:", f"Date: {дата}")
        найти_и_заменить_текст(страница, "Date: ", f"Date: {дата}")  # Проверка с пробелом
